...
export class AddCiudadesComponent implements OnInit {
  ...
  // Cuando se graba aqui tenia un problema porque solo enviaba el id del pais, pero en el backend se definio
  ...
  onSubmit(){
    ...
    if (this.formularioRegistro.invalid) {
      console.log("entro a invalid form, formulario invalido.")      
      return;
    }

    // Asignamos cada campo del formulario al modelo o entidad pais, el nombre del campo debe ir
    // exactamente igual.
