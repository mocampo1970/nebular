...
export class PaisService {
  ...
  getAll(): Observable<Pais[]>{
    console.log("entro a paisService en getAll")
    return this.httpClient.get<Pais[]>(this.baseUrl);
  }

  // Obtener un pais en la apirest hace referencia a obtenerPais que se llama 
  // con Getmapping y asi como en el springboot en el paisController en el metodo
  // obtenerPais pasa un integer que es el id, aqui debe ser lo mismo
